...
{
    public class ServerManagerUpdateMemory
    {
        ...
        public void UpdateServerName(AppState _state, int InstanceID)
        {
            ...
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x001BF400, Ptr1, Ptr1.Length, ref Ptr1Read);
            int Ptr2 = BitConverter.ToInt32(Ptr1, 0);

            byte[] ServerName = new byte[31];
            int ServerNamePtrRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)Ptr2 + 0x4, ServerName, ServerName.Length, ref ServerNamePtrRead);
            ...
            int Ptr3Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)Ptr2 + 0x000A7088, Ptr3, Ptr3.Length, ref Ptr3Read);
            int ServerDisplayerName = BitConverter.ToInt32(Ptr3, 0);

            byte[] ServerNameDisplay = new byte[31];
            int ServerNameRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)ServerDisplayerName + 0x30, ServerNameDisplay, ServerNameDisplay.Length, ref ServerNameRead);
        ...
        public void UpdateCountryCode(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000AC7C8, Ptr1, Ptr1.Length, ref Ptr1Read);
            int Ptr2Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] Ptr2 = new byte[4];
            int Ptr2Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)Ptr2Addr + 0x11, Ptr2, Ptr2.Length, ref Ptr2Read);
            string NovaCountryCode = Encoding.Default.GetString(Ptr2);


            byte[] Ptr3 = new byte[4];
            int Ptr3Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000A7088, Ptr3, Ptr3.Length, ref Ptr3Read);
            int Ptr4 = BitConverter.ToInt32(Ptr3, 0);
            byte[] Ptr5Addr = new byte[4];
            int Ptr5AddrRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)Ptr4 + 0x50 + 0x53, Ptr5Addr, Ptr5Addr.Length, ref Ptr5AddrRead);
        ...
        internal void UpdateSessionType(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DDC3C, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] SessionTypeBytes = new byte[4];
            int SessionTypeRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, SessionTypeBytes, SessionTypeBytes.Length, ref SessionTypeRead);
        ...
        public void UpdateMaxSlots(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D97A0, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] MaxSlotsBytes = new byte[4];
            int MaxSlotsRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, MaxSlotsBytes, MaxSlotsBytes.Length, ref MaxSlotsRead);
        ...
        public void UpdateTimeLimit(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DD1DC, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] TimeLimitBytes = new byte[4];
            int TimeLimitRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, TimeLimitBytes, TimeLimitBytes.Length, ref TimeLimitRead);
        ...
        public void UpdateStartDelay(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D7F00, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] StartDelayBytes = new byte[4];
            int StartDelayRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, StartDelayBytes, StartDelayBytes.Length, ref StartDelayRead);
        ...
        public void UpdateLoopMaps(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DB6A0, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] LoopMapsBytes = new byte[4];
            int LoopMapsRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, LoopMapsBytes, LoopMapsBytes.Length, ref LoopMapsRead);
        ...
        public void UpdateRespawnTime(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DD4E8, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] RespawnTimeBytes = new byte[4];
            int RespawnTimeRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, RespawnTimeBytes, RespawnTimeBytes.Length, ref RespawnTimeRead);
        ...
        public void UpdateRequireNovaLogin(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D9960, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] RequireNovaBytes = new byte[4];
            int RequireNovaRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, RequireNovaBytes, RequireNovaBytes.Length, ref RequireNovaRead);
        ...
        public void UpdateAllowCustomSkins(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000AD760, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] AllowCustomSkinsBytes = new byte[4];
            int AllowCustomSkinsRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, AllowCustomSkinsBytes, AllowCustomSkinsBytes.Length, ref AllowCustomSkinsRead);
        ...
        public void UpdateMOTD(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D9AAC, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] MOTDBytes = new byte[85];
            int MOTDRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, MOTDBytes, MOTDBytes.Length, ref MOTDRead);
        ...
        public void UpdateMinPing(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DB628, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] MinPingBytes = new byte[4];
            int MinPingRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, MinPingBytes, MinPingBytes.Length, ref MinPingRead);
        ...
        public void UpdateMinPingValue(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D7FB8, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] MinPingValueBytes = new byte[4];
            int MinPingValueRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, MinPingValueBytes, MinPingValueBytes.Length, ref MinPingValueRead);
        ...
        internal void UpdateMaxPing(AppState _state, int InstanceID)
        {
            var baseAddr = 0x400000;

            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DB634, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] MaxPingBytes = new byte[4];
            int MaxPingRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr + 0x4, MaxPingBytes, MaxPingBytes.Length, ref MaxPingRead);
        ...
        public void UpdateMaxPingValue(AppState _state, int InstanceID)
        {
            ...
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, MaxPingValueBytes, MaxPingValueBytes.Length, ref MaxPingValueRead);
        ...
        public void UpdateOneShotKills(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D8580, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] OneShotKillsBytes = new byte[4];
            int OneShotKillsRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, OneShotKillsBytes, OneShotKillsBytes.Length, ref OneShotKillsRead);
        ...
        public void UpdateFatBullets(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D7F14, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] FatBulletsBytes = new byte[4];
            int FatBulletsRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, FatBulletsBytes, FatBulletsBytes.Length, ref FatBulletsRead);
        ...
        public void UpdateDestroyBuildings(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D99B8, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] DestroyBuildingsBytes = new byte[4];
            int DestroyBuildingsRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, DestroyBuildingsBytes, DestroyBuildingsBytes.Length, ref DestroyBuildingsRead);
        ...
        public void UpdateBluePassword(AppState _state, int InstanceID, int oldPwLength)
        {
            ...
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, BluePasswordBytes, BluePasswordBytes.Length, ref BluePasswordRead);
        ...
        public void UpdateRedPassword(AppState _state, int InstanceID, int oldPwLength)
        {
            ...
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr + 0x33, RedPasswordBytes, RedPasswordBytes.Length, ref RedPasswordRead);
        ...
        public void UpdatePSPTakeOverTime(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DB6FC, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] PSPTakeOverTimeBytes = new byte[4];
            int PSPTakeOverTimeRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr + 0x4, PSPTakeOverTimeBytes, PSPTakeOverTimeBytes.Length, ref PSPTakeOverTimeRead);
        ...
        public void UpdateFlagReturnTime(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DB6AC, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] FlagReturnTimeBytes = new byte[4];
            int FlagReturnTimeRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, FlagReturnTimeBytes, FlagReturnTimeBytes.Length, ref FlagReturnTimeRead);
        ...
        public void UpdateMaxTeamLives(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D8554, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] MaxTeamLivesBytes = new byte[4];
            int MaxTeamLivesRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, MaxTeamLivesBytes, MaxTeamLivesBytes.Length, ref MaxTeamLivesRead);
        ...
        public void UpdateFriendlyFireKills(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000DB684, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] FriendlyFireKillsBytes = new byte[4];
            int FriendlyFireKillsRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, FriendlyFireKillsBytes, FriendlyFireKillsBytes.Length, ref FriendlyFireKillsRead);
        ...
        internal void GamePlayOptions(AppState _state, int InstanceID)
        {
            ...
            byte[] Ptr1 = new byte[4];
            int Ptr1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, (int)baseAddr + 0x000D7D6C, Ptr1, Ptr1.Length, ref Ptr1Read);

            int Ptr1Addr = BitConverter.ToInt32(Ptr1, 0);
            byte[] GamePlayOptionsOneBytes = new byte[4];
            int GamePlayOptionsOneRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Addr, GamePlayOptionsOneBytes, GamePlayOptionsOneBytes.Length, ref GamePlayOptionsOneRead);
        ...
        public void UpdateWeaponRestrictions(AppState _state, int InstanceID)
        {
            ...
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, Ptr1Location, Ptr1Bytes, Ptr1Bytes.Length, ref Ptr1Read);
        ...
        public void UpdateMapCycle2(AppState _state, int InstanceID)
        {
            ...
            int Pointer1Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, appEntry + 0x000DC6D8, Pointer1Bytes, Pointer1Bytes.Length, ref Pointer1Read);
            ...
            UpdateSecondaryMapList(_state, _state.Instances[InstanceID].Handle, InstanceID);
        }

        private void UpdateSecondaryMapList(AppState _state, IntPtr handle, int InstanceID)
        {
            int appEntry = 0x400000;
        ...
        public void UpdateNextMap(AppState _state, int InstanceID, int NextMapIndex)
        {
            ...
            byte[] ServerMapCyclePtr = new byte[4];
            int Pointer2Read = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, appEntry + 0x005ED5F8, ServerMapCyclePtr, ServerMapCyclePtr.Length, ref Pointer2Read);
        ...
        internal void UpdateMapCycle(AppState _state, int InstanceID)
        {
            ...
            byte[] mapCycleListAddress = new byte[4];
            int mapCycleListAddressRead = 0;
            ReadProcessMemory((int)_state.Instances[InstanceID].Handle, mapCycleServerAddress, mapCycleListAddress, mapCycleListAddress.Length, ref mapCycleListAddressRead);
            int mapCycleList = BitConverter.ToInt32(mapCycleListAddress, 0);
