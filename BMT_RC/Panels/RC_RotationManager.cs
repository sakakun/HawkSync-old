...
namespace HawkSync_RC
{
    public partial class RC_RotationManager : Form
    {
        AppState _state;
        RCSetup RCSetup;
        TVRotationManagerCMD TVRotationManagerCMD;
        int ArrayID = -1;
        string uploadDirectory;
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        List<MapList> avilableMaps;
        ...
        private void RotationManager_Load(object sender, EventArgs e)
        {
            ...
            {
                comboBox8.Items.Add(gameType.Value.Name);
            }
            ...
            {
                listBox6.Items.Add(item.Description);
            }
        ...
        private void listBox6_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                return; // do nothing since nothing was selected...
            }
            ...
            else
            {
                ...
                listBox5.Items.Clear();
                int rotationIndex = listBox6.SelectedIndex;
                rotationIndex--;
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            {
                if (TVRotationManagerCMD.UpdateRotation(selectedMaps, textBox14.Text, (listBox6.SelectedIndex - 1)) == OpenClass.Status.SUCCESS)
                {
                    MessageBox.Show("Rotation saved successfully!", "Success");
                }
                else
        ...
        {
            // delete rotation
            if (listBox6.SelectedIndex == -1 || listBox6.SelectedIndex == 0)
            {
                return;    // do nothing since nothing was selected...
            }
            if (TVRotationManagerCMD.DeleteRotation(_state.Instances[ArrayID].savedmaprotations[listBox6.SelectedIndex - 1].RotationID) == OpenClass.Status.SUCCESS)
            {
            ...
            {
                MessageBox.Show("Something went wrong while attempting to delete the rotation.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        }
        ...
        private void listBox4_DoubleClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string mapName = avilableMaps[listBox4.SelectedIndex].MapName;
                string mapFile = avilableMaps[listBox4.SelectedIndex].MapFile;
                string gameType = avilableMaps[listBox4.SelectedIndex].GameType;
